  ...
  {category.brands.map((brand) => (
    ...
    > 
      <div className={`bg-gradient-to-br ${category.bgGradient} backdrop-blur-sm rounded-2xl sm:rounded-3xl p-0 shadow-xl group-hover/card:shadow-2xl ${category.shadowColor} transition-all duration-700 border border-white/50 relative overflow-hidden h-40 sm:h-48`}>
        ...
        <div className="absolute top-2 right-2 sm:top-3 sm:right-3 z-20">
          <p className="text-[10px] sm:text-xs text-gray-500 bg-white/100 backdrop-blur-sm px-2 py-0.5 sm:py-1 rounded-md font-medium">
            {brand.description}
          </p>
        </div>

        {/* Centered Image */}
        <div className="relative z-10 h-full flex items-center justify-center p-6 sm:p-10 md:p-12">
          <div className="transform group-hover/card:scale-110 transition-all duration-500">
            <img
              src={brand.img}
              alt={brand.name}
              className="h-12 sm:h-16 md:h-20 w-auto object-contain drop-shadow-lg mx-auto"
              loading="lazy"
            />
          </div>
        </div>
        ...
        <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 opacity-0 group-hover/card:opacity-100 transition-all duration-500 translate-y-2 group-hover/card:translate-y-0 z-20">
          <div className="flex items-center gap-1 sm:gap-2 text-gray-600 bg-white/80 backdrop-blur-sm px-2 sm:px-3 py-0.5 sm:py-1 rounded-full">
            <span className="text-[10px] sm:text-xs font-medium">Explore</span>
            <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 transform group-hover/card:translate-x-1 transition-transform duration-300" />
          </div>
        </div>
      </div>
    </Link>
