      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-5">
          <img
            src={Miaimg}
            alt=""
            className="h-16 sm:h-20 mx-auto object-contain drop-shadow-lg mb-2"
            loading="lazy"
          />
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mb-10">
          ...
          <div className="group relative w-full sm:w-[400px] h-auto rounded-2xl bg-white/70 backdrop-blur-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-200">
            ...
            <div className="w-full text-center py-3 bg-white/80 backdrop-blur-sm border-t border-gray-200">
              <span className="text-sm sm:text-base font-medium text-gray-700">Chetakpuri Store</span>
            </div>
          </div>

          {/* If more stores are added, duplicate this block */}
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>0751-4024777, +91-09402477</li>
