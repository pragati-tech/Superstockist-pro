      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-5">
          <img
            src={Fastrackimg}
            alt=""
            className="h-30 mx-auto object-contain drop-shadow-lg"
            loading="lazy"
          />
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mt-3">
            We are currently operating 2 stores of Fastrack, the one opened in 2018, 
            offering watches, sunglasses, bags, and other accessories.
          </p>
        </div>

        {/* Store Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 place-items-center">
          {/* Card 1 */}
          <div className="group relative w-full max-w-[400px] rounded-2xl bg-white/70 backdrop-blur-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-200">
