  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Responsive Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1  gap-6 mb-10">
          {/* Card 1 */}
          <a target="_blank" href={Catalogue1}>
            <div className="group relative w-full max-w-[350px] mx-auto aspect-[7/8] rounded-2xl bg-white/70 backdrop-blur-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-200">
              <div
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                <div className="flex items-center gap-2 text-gray-700 bg-white/80 backdrop-blur-sm px-3 py-3 rounded-full shadow">
                  <span className="text-xs font-medium">July'25 Catalogue</span>
